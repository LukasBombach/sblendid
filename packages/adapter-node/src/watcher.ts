...
export default class Watcher<M extends Emitter<any>, E extends Event<M>> {
  private promise: Promise<Value<M, E>>;
  private queue = new Queue();

  public static async resolved<M extends Emitter<any>, E extends Event<M>>(
    emitter: M,
    event: E,
